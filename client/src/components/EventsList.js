        ...
        <FlexColumn1 gap={`70px`}>
          ...
          <FlexColumn1 gap={`40px`}>
            <FlexRow10>
              <Card height={`auto`}>
                <Image1
                  src={`https://file.rendit.io/n/9Uls8kE49aAmvtKuUD8W.png`}
                />
                <FlexColumn4>
                  <FlexRow11>
                    <TituloEvento>
                      <Typography14>Kyle Savage</Typography14>
                ...
                <Image10
                  src={`https://file.rendit.io/n/bOILowVehxCZvNGw66HF.svg`}
                />
                <FlexColumn6>
                  <StickyCTA>
                    <FlexColumn7>
              ...
              <Card height={`auto`}>
                ...
                <FlexColumn6>
                  <StickyCTA>
                    ...
                    <ButtonContained
                      onClick={(e) =>
                        ButtonContainedFunction(e, "ButtonContained1")
                      }
                    >
                      <Base>
                        <Button1>MINT</Button1>
              ...
              <Card height={`auto`}>
                ...
                <FlexColumn6>
                  <StickyCTA>
                    ...
                    <ButtonContained
                      onClick={(e) =>
                        ButtonContainedFunction(e, "ButtonContained2")
                      }
                    >
                      <Base>
                        <Button1>MINT</Button1>
              ...
              <Card height={`auto`}>
                ...
                <FlexColumn6>
                  <StickyCTA>
                    ...
                    <ButtonContained
                      onClick={(e) =>
                        ButtonContainedFunction(e, "ButtonContained3")
                      }
                    >
                      <Base>
                        <Button1>MINT</Button1>
          ...
          <FlexColumn1 gap={`40px`}>
            <FlexRow10>
              <Card height={`40.98px`}>
                <Image5
                  src={`https://file.rendit.io/n/K7jKNcwqwMZS1sCXBSQk.png`}
                />
                <FlexColumn4>
                  <FlexRow11>
                    <TituloEvento>
                    ...
                    <FlexRow1 gap={`10px`}>
                      <FlexColumn5>
                        <Typography18>Owned by</Typography18>
                        <Typography87>Sam</Typography87>
                      </FlexColumn5>
                      <Ellipse
                        src={`https://file.rendit.io/n/mhEaEqzOE2cPNInRru98.png`}
                      />
                    </FlexRow1>
                  </FlexRow11>
                  <Bullets>
                    <FlexRow1 gap={`10px`}>
                      <HomeFilled src={`undefined`} />
                      <FlexRow>
                        <Typography21 width={`89px`}>Arena CDMX</Typography21>
                      </FlexRow>
                    </FlexRow1>
                ...
                <FlexColumn6>
                  <StickyCTA>
                    ...
                    <ButtonContained
                      onClick={(e) =>
                        ButtonContainedFunction(e, "ButtonContained4")
                      }
                    >
                      <Button5>MINT</Button5>
                    </ButtonContained>
                  </StickyCTA>
                  <FlexRow15>
                    <AccessTimeFilled src={`undefined`} />
                    <Typography29>VIEW HISTORY</Typography29>
                  </FlexRow15>
                </FlexColumn6>
              </Card>
              <Card height={`40.98px`}>
                ...
                <FlexColumn6>
                  <StickyCTA>
                    ...
                    <ButtonContained
                      onClick={(e) =>
                        ButtonContainedFunction(e, "ButtonContained5")
                      }
                    >
                      <Button5>MINT</Button5>
                    </ButtonContained>
              ...
              <Card height={`40.98px`}>
                ...
                <FlexColumn6>
                  <StickyCTA>
                    ...
                    <ButtonContained
                      onClick={(e) =>
                        ButtonContainedFunction(e, "ButtonContained6")
                      }
                    >
                      <Button5>MINT</Button5>
                    </ButtonContained>
              ...
              <Card height={`40.98px`}>
                ...
                <FlexColumn6>
                  <StickyCTA>
                    ...
                    <ButtonContained
                      onClick={(e) =>
                        ButtonContainedFunction(e, "ButtonContained7")
                      }
                    >
                      <Button5>MINT</Button5>
                    </ButtonContained>
